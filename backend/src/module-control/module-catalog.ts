...
export const MODULE_CATALOGUE: readonly ModuleDefinition[] = [
  ...
  definition(
    'sis_academics',
    'SIS / Academics',
    ['/academics', '/student/academics', '/faculty'],
    [
      '/api/academics',
      '/api/faculty-ai',
      '/api/student',
  ...
  definition(
    ...
    [
      '/api/lms',
      '/api/weekly-tests',
      '/api/academics/faculty/courses',
      '/api/academics/faculty/workspaces',
      '/api/academics/faculty/assignments',
      '/api/academics/faculty/materials',
      '/api/academics/faculty/announcements',
      '/api/academics/faculty/question-bank',
      '/api/academics/assignments',
      '/api/academics/student/courses',
      '/api/academics/student/assignments',
    ],
    ['Dean', 'HOD', 'LMSAdmin'],
    [{ moduleKey: 'sis_academics', kind: 'READ_ONLY_PROJECTION' }],
  ),
  definition(
    'examinations_credentials',
