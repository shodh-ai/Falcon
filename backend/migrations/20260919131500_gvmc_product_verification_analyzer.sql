-- The GVMC procurement reviewer runs deterministic Module 4 analysis while
-- the independent inventory verifier retains the human review authority.
...
WHERE NOT EXISTS (
  ...
  WHERE existing.tenant_id = reviewer.tenant_id
    ...
    AND existing.capability = 'PRODUCT_VERIFICATION_ANALYZE'
