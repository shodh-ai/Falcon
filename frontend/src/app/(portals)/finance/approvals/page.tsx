...
export default function ApprovalsInboxPage() {
  ...
  return (
    <div className="space-y-4 p-6">
      <h1 className="text-2xl font-black text-sgvu-navy">DOFA Approvals</h1>
      <p className="text-sm text-muted-foreground max-w-2xl">
        Level inbox. Level 3 (₹50k–₹5L) needs both Procurement Head and Finance Controller
        signatures before a PO is generated.
      </p>
