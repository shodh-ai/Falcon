...
export default function WardenGrievancesPage() {
    ...
    <div className="space-y-6 p-6">
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">Maintenance and Hostel helpdesk tickets escalated to Warden.</p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr><td colSpan={4} className="p-4 text-center text-muted-foreground">No open maintenance grievances.</td></tr>
                ) : (
                  rows.map((r) => (
