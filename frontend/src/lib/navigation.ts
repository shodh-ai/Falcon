...
export const studentPortal: PortalConfig = {
  ...
  navGroups: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Official Transcripts', href: '/student/transcripts', icon: FileText, keywords: ['transcript', 'download', 'verification'] },
  ...
  commandItems: [
    ...
    { label: 'Official Transcripts', href: '/student/transcripts', icon: FileText },
  ...
  navGroups: [
    {
      ...
      items: [
        ...
        { label: 'Research Grants', href: '/research/grants', icon: FlaskConical, keywords: ['grants', 'funding', 'serb', 'dst', 'rms'], roles: ['IQAC', 'Faculty', 'SuperAdmin', 'Chairman', 'DeanOfResearch', 'LabAdmin'] },
        { label: 'IP Docket', href: '/research/ip', icon: FileLock, keywords: ['patent', 'ip', 'disclosure'], roles: ['IQAC', 'Faculty', 'SuperAdmin', 'Chairman', 'DeanOfResearch', 'LabAdmin'] },
