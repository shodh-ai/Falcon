...
export const studentPortal: PortalConfig = {
  ...
  navGroups: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Clubs & Chapters', href: '/student/clubs-chapters', icon: Users, keywords: ['club', 'chapter', 'nss', 'ncc', 'ieee', 'apply', 'membership'] },
  ...
  commandItems: [
    ...
    { label: 'Clubs & Chapters', href: '/student/clubs-chapters', icon: Users },
