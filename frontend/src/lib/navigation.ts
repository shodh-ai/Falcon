  ...
  navGroups: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Universal Inventory', href: '/finance/inventory', icon: Archive, keywords: ['module 5', 'asset id', 'rfid', 'lot', 'custody', 'inventory identity'], roles: ['Stores', 'ReceivingClerk', 'ProcurementHead', 'InternalAuditor', 'SuperAdmin'] },
        { label: 'Physical Identity & Gates', href: '/finance/physical-identity', icon: RadioTower, keywords: ['module x', 'rfid', 'label', 'kiosk', 'gate', 'physical identity'], roles: ['Stores', 'Security', 'ProcurementHead', 'InternalAuditor', 'SuperAdmin'] },
        { label: 'Consumables Operations', href: '/finance/consumables', icon: Boxes, keywords: ['module 6', 'consumables', 'lot', 'fefo', 'reservation', 'stock count', 'replenishment'], roles: ['Faculty', 'LabAdmin', 'Stores', 'ProcurementHead', 'InternalAuditor', 'SuperAdmin'] },
        { label: 'Returns & DOA', href: '/finance/returns', icon: RotateCcw, keywords: ['module 7', 'return', 'doa', 'rma', 'refund', 'replacement', 'vendor'], roles: ['Faculty', 'LabAdmin', 'Stores', 'ProcurementHead', 'Finance', 'InternalAuditor', 'SuperAdmin'] },
        { label: 'Asset Service & Warranty', href: '/finance/asset-service', icon: Wrench, keywords: ['module 8', 'repair', 'warranty', 'maintenance', 'calibration', 'service'], roles: ['Faculty', 'LabAdmin', 'Stores', 'ProcurementHead', 'Finance', 'InternalAuditor', 'SuperAdmin'] },
        { label: 'Asset Retirement & Disposal', href: '/finance/asset-retirement', icon: Recycle, keywords: ['module 9', 'retirement', 'write-off', 'sanitization', 'auction', 'recycling', 'disposal'], roles: ['Faculty', 'LabAdmin', 'Stores', 'ProcurementHead', 'Finance', 'InternalAuditor', 'SuperAdmin'] },
