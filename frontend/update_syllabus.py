...
with open(r'd:\Falcon\frontend\src\app\(portals)\hod\academics\syllabus-tracking\page.tsx', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open(r'd:\Falcon\frontend\src\app\(portals)\hod\academics\syllabus-tracking\page.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
